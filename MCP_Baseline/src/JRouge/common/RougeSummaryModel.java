package JRouge.common;

import JRouge.interfaces.IRougeSummaryModel;
import JRouge.interfaces.IRougeSummaryModelAdapter;
...
/**
 * This is a class that should be used straight, or through an adapter ({@link IRougeSummaryModelAdapter}
 * <p>
 * The idea behind this class is to contain all the needed data to evaluate the text using the JRouge<br>
 * implementation of Rouge, or export the data to text files and run on them the original Rouge script
 * 
 * @author nocgod
 */
public class RougeSummaryModel implements IRougeSummaryModel
{
     ...
     * 
     * @param sourceFile
     *            The source file the contains the text
     */
