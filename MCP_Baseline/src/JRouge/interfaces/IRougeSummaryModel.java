...
public interface IRougeSummaryModel
{
     ...
     *            The sentence to add
     * @param index
     *            The index at which to insert the sentence
     * @return this object, so the calls could be chained
     */
     ...
     * @return this object, so the calls could be chained, null in case failed to remove item
     */
     ...
     * 
     * @param index
     *            The index from which to retrieve the sentence
     * @return The sentence
     */
